angular.module('travel.pricingModule')
    .factory('travel.pricingModule.webApi', ['$resource', function ($resource) {
        return $resource('api/TravelPricingModule');
    }]);
...
angular.module('travel.pricingModule')
    ...
    //    });
    //}])
    //.factory('travel.pricingModule.pricelists', ['$resource', function ($resource) {
