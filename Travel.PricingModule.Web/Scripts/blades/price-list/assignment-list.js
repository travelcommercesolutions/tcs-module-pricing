angular.module('travel.pricingModule')
    .controller('travel.pricingModule.assignmentListController', ['$scope', 'virtoCommerce.pricingModule.pricelistAssignments', 'platformWebApp.dialogService', 'platformWebApp.uiGridHelper', 'platformWebApp.bladeUtils', 'virtoCommerce.catalogModule.catalogs', '$localStorage',
        function ($scope, assignments, dialogService, uiGridHelper, bladeUtils, catalogs, $localStorage) {
                ...
                assignments.search(getSearchCriteria(), function (data) {
                    ...
                    catalogs.getCatalogs(function (results) {
                        ...
                        if (selectedVendorId != null) {
                            var priceAssignments = data.results;
                            priceAssignments = priceAssignments.filter(c => c.catalogId == vendoCatalogueId);
                        }
                        else {
                            var priceAssignments = data.results;
                         }
            ...
            $scope.selectNode = function (node, isNew) {
                ...
                var newBlade = {
                    ...
                    template: 'Modules/$(TCS.PricingModule)/Scripts/blades/price-list/assignment-detail.tpl.html'
                };
